			...
			<?php if ( 'open' == $post->comment_status ) : ?>
				<ol class="commentlist">
					<li class="no-comments">
						<p>It&lsquo;s quiet in here! Why not leave a <a href="#respond">response</a>?</p>
					</li>
				</ol>
					<br />
			<?php else : ?>
			...
			<?php else : ?>
				...
				<form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post" id="commentform">
					...
					<?php else : ?>
						...
						<p><input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="32" tabindex="1" class="input" 
																							<?php
																							if ( $req ) {
...
?>
						...
						<p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="32" tabindex="2" class="input" 
																						<?php
																						if ( $req ) {
																							echo "aria-required='true'";}
?>
